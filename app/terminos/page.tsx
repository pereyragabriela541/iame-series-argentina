...
export const metadata = {
  ...
  description:
    "Términos y condiciones de uso del sitio y de la aplicación móvil BS Proyect (oficial de IAME Series Argentina).",
};
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Condiciones de uso del sitio web y de la app BS Proyect"
      />
